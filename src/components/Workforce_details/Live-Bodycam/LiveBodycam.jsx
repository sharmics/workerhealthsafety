...
import "../Live-Bodycam/LiveBodycam.css"
import { useLocation, useNavigate, useParams } from 'react-router-dom';
import data_set from '../../../Services/DataService';



function LiveBodycam() {
    ...
    useEffect(() => {
        if (location.pathname === `/dashboard/live-bodycam/${workerId}`) {
    ...
    return (
        <div className={fullscreenToggle ? 'Live-Bodycam-outer' : "Live-Bodycam-outer2"}>
            <div onClick={() => navigate(`/dashboard/workforce/${workerId}`)} className={fullscreenToggle ? 'Live-Bodycam-BackIcon' : 'Live-Bodycam-BackIcon2'}>
            ...
            <div className={fullscreenToggle ? 'Live-Bodycam-live' : 'Live-Bodycam-live2'}>
                {fullscreenToggle ? "" :
                    (<div className='live-feed-Large1'>
                        <div style={{marginLeft:"10px"}}>Live Bodycam</div>
                        <div onClick={() => navigate(`/dashboard/live-bodycam/${workerId}`)} style={{ cursor: "pointer",marginRight:"10px", display:"flex", alignItems:"center"  }}><svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {workerData && ( <video
                    ...
                    controls ={false}
                >
                    <source src={workerData?.live_body_cam} type="video/mp4" />
                </video>)
                }
            </div>
        </div>
